...
class MonthCollectionCell: UICollectionViewCell, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        if(cell.date!.mark && selectedDate == date && selectedDate != nil){
            cell.mark = false
            cell.date!.mark = false
        }else if(cell.date!.mark && selectedDate != date && selectedDate != nil){
            cell.mark = true
            cell.date!.mark = true
        }else if (selectedDate != nil){
            cell.mark = selectedDate == date
            cell.date!.mark = selectedDate == date
        }
